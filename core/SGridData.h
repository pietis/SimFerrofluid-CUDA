...
namespace Pivot {
	...
	public:
		...
		Type GetMaxAbsComponent() const requires (std::is_arithmetic_v<Type>) { return std::max({ m_Datas[0].GetMaxAbsValue(), m_Datas[1].GetMaxAbsValue(), m_Datas[2].GetMaxAbsValue() }); }
